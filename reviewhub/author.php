    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                ?>
                    <h2 class="page-heading">Review By <?php echo $row1['username']; ?></h2>
                    <?php
                  ...
                  genre.genre_name,user.username,post.genre,post.post_img FROM post
                                ...
                                <div class="inner-content clearfix">
                                    ...
                                    <div class="post-information">
                                        <span>
                                            ...
                                            <a
                                                href='genre.php?cid=<?php echo $row['genre']; ?>'><?php echo $row['genre_name']; ?></a>
                                        </span>
                                        <span>

<div id="sidebar" class="col-md-4">
    ...
    <div class="search-box-container">
        ...
        <form class="search-post" action="search.php" method="GET">
            <div class="input-group">
                <input id="search_text" type="text" name="search" class="form-control" placeholder="Search .....">
    ...
    <div class="recent-post-container">
        ...
        genre.genre_name, post.genre, post.post_img 
        FROM post
        ...
        <div class="recent-post">
            ...
            <div class="post-content">
                ...
                <span>
                    ...
                    <a href='genre.php?cid=<?php echo $row['genre']; ?>'><?php echo $row['genre_name']; ?></a>
                </span>
                <span>
